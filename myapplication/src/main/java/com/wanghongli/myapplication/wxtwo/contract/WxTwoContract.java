package com.wanghongli.myapplication.wxtwo.contract;
...
public interface WxTwoContract {
    interface Model {
    ...
    public abstract class DataSource {
        public abstract Observable<List<DataBean>> getTab();
    ...
    interface View extends IBaseView<WxTwoContract.Presenter> {
        void setTabData(List<TabBean> banner, String msg);
    ...
    interface Presenter extends IBasePresenter<WxTwoContract.View> {
